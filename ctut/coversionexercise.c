...
label:
    ...
    if (a == 1)
    {
        ...
        printf("press 2 for cms to inches\n");
        ...
        case 1:
            ...
            goto label;
        case 2:
            printf("you have selected conversion of cms into inches\n");
            int d;
            ...
            goto label;
        case 3:
            printf("you have selected conversion of inches into foot\n");
            int e;
            ...
            goto label;
        case 4:
            printf("you have selected conversion of pounds into kgs\n");
            int f;
            ...
            goto label;
        case 5:
            printf("you have selected conversion of inches into meter\n");
            int g;
